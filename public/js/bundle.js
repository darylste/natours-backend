...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFyeWwxMyIsImEiOiJjbDc3ZHg0bmQwa3NyM3FwZzNhb3I4ZnN5In0.h5-7dA78DVZXgy22YGQaXA';
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>\n        Day ".concat(location.day, ": ").concat(location.description, "\n      </p>")).addTo(map);
